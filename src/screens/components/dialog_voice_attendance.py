...
import pandas as pd
from src.screens.components.dialog_attendance_result import show_attendance_results
    ...
    if st.button("Analyze Audio", width='stretch', type='primary'):
     with st.spinner("processing audio data"):
        ...
        for node in enrolled_students:
             ...
             score= detected_sources.get(student['student_id'], 0.0)# fro multi sources we use [] student come twice in second image 
             is_present= bool(score) > 0 # if voice embed.. more than 0 it means person present 
